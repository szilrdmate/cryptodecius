...
const Calendly = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto grid md:grid-cols-2 grid-cols-1 gap-4 md:p-8 p-0 border border-solid border-light-gray border-opacity-20 rounded-2xl shadow-lg bg-[#fff] h-[630px] overflow-hidden">
      <div className="p-4">
