...
const Footer = () => {
  return (
    < div className="w-screen bg-dark-blue">
      <div className="flex justify-center align-middle mx-auto container py-8 px-4">
        <div id="footer" className="mx-auto">
          <p className="text-light-gray font-thin  mb-4 text-sm max-w-5xl text-justify">
      ...
      <div className="bg-purple text-white py-4 h-20 flex align-middle px-4">
